...
HD_PWD='C:/Users/PsilosC/Desktop/Hex_Editor_Final/Hex_Editor_Final.runs/Hex_Editor_Debounce_Switch_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hex_Editor_Debounce_Switch_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hex_Editor_Debounce_Switch_1_0.tcl
