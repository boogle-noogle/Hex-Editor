...
HD_PWD='C:/Users/PsilosC/Desktop/Hex_Editor_Final/Hex_Editor_Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hex_Editor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hex_Editor_wrapper.tcl
