...
HD_PWD='C:/Users/PsilosC/Desktop/Hex_Editor_Final/Hex_Editor_Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Hex_Editor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Hex_Editor_wrapper.tcl -notrace
