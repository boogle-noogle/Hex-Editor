...
################################################################
# This is a generated script based on design: Hex_Editor
#
...
# source Hex_Editor_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# AsciiCharsMem, Debounce_Switch, Debounce_Switch, Debounce_Switch, ScreenBufferMem, VGA_pattern, VGA_timings, num_capture_4bit
...
proc create_root_design { parentCell } {
  ...
  set iSpace [ create_bd_port -dir I iSpace ]
  ...
  connect_bd_net -net Debounce_Switch_2_o_Switch [get_bd_pins Debounce_Switch_2/o_Switch] [get_bd_pins num_capture_4bit_0/iSpace]
  ...
  connect_bd_net -net clk_in1_0_1 [get_bd_ports iClk] [get_bd_pins Debounce_Switch_0/i_Clk] [get_bd_pins Debounce_Switch_1/i_Clk] [get_bd_pins Debounce_Switch_2/i_Clk] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net iRst_0_1 [get_bd_ports iRst] [get_bd_pins ScreenBufferMem_0/iRst] [get_bd_pins VGA_pattern_0/iRst] [get_bd_pins VGA_timings_0/iRst] [get_bd_pins num_capture_4bit_0/iRst]
  connect_bd_net -net i_Switch_0_1 [get_bd_ports iPush] [get_bd_pins Debounce_Switch_0/i_Switch]
  connect_bd_net -net i_Switch_0_2 [get_bd_ports iSpace] [get_bd_pins Debounce_Switch_2/i_Switch]
  connect_bd_net -net i_Switch_0_3 [get_bd_ports iStop] [get_bd_pins Debounce_Switch_1/i_Switch]
